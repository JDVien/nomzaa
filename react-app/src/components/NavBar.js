  ...
  useEffect(() => {
    ...
    setFilteredList(
      productlist.filter((product) =>
        product[0].toLowerCase().includes(searchWord.toLowerCase())
      )
    );
  }, [searchWord, dispatch]);
        ...
        <div className="nav_container">
          <div id="nav_row_top">
            <div className="nav_top_left">
              <div id="nom_nav_logo">
                <NavLink className="navlink_nav_item" to="/">
                  <img
                    id="nomzaa_logo_main_sm"
                    src="/static/images/nomza_logo_main_lg.png"
                    alt="nomzaa logo"
                    width="120"
                    height="auto"
                  />
              ...
              {user && (
                <div id="nav_user_location">
                  <span id="user_deliver_text">
                    Deliver to {user?.fullname}
                  </span>
                  <br />
                  <i className="fas fa-map-marker-alt"></i>
                  <span id="user_city_zip_text">
                    ...
                    <div className="search_result_body">
                      <ul className="search_result_list">
                        {filteredList?.slice(0, 10).map((product) => (
                          <li
                            className="search_result_li"
                            key={product.id}
                            value={product.long_name}
                            onClick={() => setFilteredList([])}
                          >
                            <Link
                              className="search_to_link"
                              to={{
                                pathname: `/products/${product[1]?.category}/${product[1]?.id}`,
            ...
            <div className="nav_top_right">
              <img
                id="region_flag_icon"
                src="/static/images/nom_nav_flag.png"
                width="24"
                height="20"
                alt="flag"
              />
          ...
          <div id="nav_row_bottom">
            <Link className="filter_link" to="/products">
              <span className="subnav_category">
                <img
                  id="nav_all_burger"
                  onClick={() => handleShowVertiCart()}
                  src="/static/images/nav-sprite-burger.png"
                  alt="burger"
                />
                All
              </span>
            ...
            <Link
              className="filter_link"
              to={{
                pathname: "/products/home-improvment",
                state: { fromMainImprovement: "home-improvement" },
              }}
            >
            ...
            <Link
              className="filter_link"
              to={{
                pathname: "/products/toys",
                state: { fromMainToys: "toys" },
              }}
            >
            ...
            <span className="subnav_category">
              <a
                className="subnav_jd_github_a"
                href="https://github.com/JDVien/nomzaa"
              >
            ...
            <span className="subnav_category">
              <a
                className="subnav_jd_github_a"
                href="https://www.linkedin.com/in/jason-v-52a595237?trk=people-guest_people_search-card"
              >
